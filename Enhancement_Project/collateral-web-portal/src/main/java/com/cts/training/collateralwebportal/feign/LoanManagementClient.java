...
public interface LoanManagementClient {
    ...
    public ApplicationDao applyLoan(@RequestBody ApplicationDao application);
    
    @GetMapping(value="/getLoanApplicationStatus/{id}")
    public ApplicationDao getStatus(@PathVariable int id);
